...
console.log(
  `nom:${pkm.nomPokemon}, nature:${pkm.nature._nomNature}, type[1:${pkm.typePrincipale.nomType}, 2:], pv[Inne:${pkm.statistiqueInnee.pv}, Finale:${pkm.statsFinale.pv}], atk [1:${pkm.attaques[0].nomAttaque}, 2:${pkm.attaques[1].nomAttaque}]`
);
